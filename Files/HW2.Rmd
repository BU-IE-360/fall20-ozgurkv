...
It appears that our assumption is correct to some extent, in that the correlation coefficient is significantly lower but one should also consider that our set of data is much smaller.
